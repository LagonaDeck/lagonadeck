...
| --------- | -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Identity  | utilisateurs, login, JWT, refresh tokens, workspaces, membres, invitations, rôles et permissions         | entité `User` (CRUD, validation, mot de passe haché via bcrypt — [ADR 0007](../adr/0007-identity-password-hashing.md)) implémentée ; login, JWT, workspaces et permissions à implémenter |
